...
const PLANOS_FALLBACK = [
  ...
  { codigo: "pro", nome: "Pro", descricao: "Até 10 páginas, sem marca, sem anúncios e com formulários ilimitados.", precoMensalCentavos: 2900, paginasMaximas: 10, removeMarca: true, dominioProprio: false, anuncios: false, destaque: true },
  { codigo: "ultra", nome: "Ultra", descricao: "Até 50 páginas, domínio próprio e prioridade no suporte.", precoMensalCentavos: 7900, paginasMaximas: 50, removeMarca: true, dominioProprio: true, anuncios: false },
];
            ...
            return (
              <article key={plano.codigo} className={CARD}>
                ...
                <p className="font-display mt-3 text-4xl">
                  {sobMedida ? "A conversar" : plano.precoMensalCentavos === 0 ? "Grátis" : formatarPreco(plano.precoMensalCentavos)}
                </p>
                ...
                <ul className="mt-4 space-y-1 text-sm text-ink-soft">
                  {sobMedida ? (
                    ...
                    <>
                      ...
                      <li>{plano.dominioProprio ? "Domínio próprio" : "Slug single.page"}</li>
                    </>
                  )}
                </ul>
